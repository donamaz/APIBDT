...
{
    public partial class BanQuanAo : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Chatlieus = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    TrangThai = table.Column<bool>(type: "bit", maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenDM = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    TrangThai = table.Column<bool>(type: "bit", maxLength: 30, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Maus = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    TrangThai = table.Column<bool>(type: "bit", maxLength: 20, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Loaisp_Danhmuc_Danhmucid",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Chatlieuid = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Sanpham_Chatlieu_Chatlieuid",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Sanpham_Mau_Mauid",
                        column: x => x.Mauid,
                        principalTable: "Mau",
                        principalColumn: "id");
                    table.ForeignKey(
                        name: "FK_Sanpham_Size_Sizeid",
                        column: x => x.Sizeid,
                        principalTable: "Size",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CTdonhang_Size_KichthuocId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CTdonhang_KichthuocId",
                table: "CTdonhang",
                column: "KichthuocId");

            migrationBuilder.CreateIndex(
                name: "IX_CTdonhang_MauId",
                table: "CTdonhang",
                column: "MauId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Loaisp_Danhmucid",
                table: "Loaisp",
                column: "Danhmucid");

            migrationBuilder.CreateIndex(
                name: "IX_Sanpham_Chatlieuid",
                table: "Sanpham",
                column: "Chatlieuid");
